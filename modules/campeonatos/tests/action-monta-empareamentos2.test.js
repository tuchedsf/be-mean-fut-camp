...
const timesPorGrupo = 4; // recuperado do campeonato
...
describe('Teste retorno empareamento equipes Campeonato', () => {
  ...
  describe('array de 6 empareamentos', () => {
    it('expect return 6 empareamentos', () => {
      expect(empareamentos).to.be.instanceof(Array);
      expect(empareamentos).to.have.lengthOf(6);
    });
